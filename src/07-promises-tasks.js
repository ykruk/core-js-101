...
function willYouMarryMe(isPositiveAnswer) {
  if (typeof isPositiveAnswer === 'boolean' && isPositiveAnswer) return new Promise((resolve) => resolve('Hooray!!! She said "Yes"!'));
  if (typeof isPositiveAnswer === 'boolean' && !isPositiveAnswer) return new Promise((resolve) => resolve('Oh no, she said "No".'));
